...
<head>
	...
	<title>Sistem Penjualan Barang</title>
...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{{ url('/') }}">Welcome To My Laravel Project</a>
			</div>
	...
	<footer class="footer hidden-print">
      <div class="container">
        <p class="text-muted">You are using <a href="https://github.com/fikr33">Sistem Penjualan Barang</a> extended by <a href="https://github.com/fikr33">Fikri Purqon Azis</a>.
        </p>
      </div>
    </footer>
	<!-- Scripts -->
